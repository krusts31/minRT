...
{
	if (hit_dig == 1)
		return (fl_parce(&(*sp)->cor->e[0], vars));
	if (hit_dig == 2)
		return (fl_parce(&(*sp)->cor->e[1], vars));
	if (hit_dig == 3)
		return (fl_parce(&(*sp)->cor->e[2], vars));
	if (hit_dig == 4)
		return (fl_parce(&(*sp)->diameter, vars));
	if (hit_dig == 5)
		return (char_parce(&(*sp)->col->e[0], vars));
	if (hit_dig == 6)
		return (char_parce(&(*sp)->col->e[1], vars));
	if (hit_dig == 7)
		return (char_parce(&(*sp)->col->e[2], vars));
	return (1);
}
