...
{
	if (hit_dig == 1)
		return (fl_parce(&(*tr)->cor1->e[0], vars));
	if (hit_dig == 2)
		return (fl_parce(&(*tr)->cor1->e[1], vars));
	if (hit_dig == 3)
		return (fl_parce(&(*tr)->cor1->e[2], vars));
	if (hit_dig == 4)
		return (fl_parce(&(*tr)->cor2->e[0], vars));
	if (hit_dig == 5)
		return (fl_parce(&(*tr)->cor2->e[1], vars));
	if (hit_dig == 6)
		return (fl_parce(&(*tr)->cor2->e[2], vars));
	if (hit_dig == 7)
		return (fl_parce(&(*tr)->cor3->e[0], vars));
	if (hit_dig == 8)
		return (fl_parce(&(*tr)->cor3->e[1], vars));
	if (hit_dig == 9)
		return (fl_parce(&(*tr)->cor3->e[2], vars));
	if (hit_dig == 10)
		return (char_parce(&(*tr)->col->e[0], vars));
	if (hit_dig == 11)
		return (char_parce(&(*tr)->col->e[1], vars));
	if (hit_dig == 12)
		return (char_parce(&(*tr)->col->e[2], vars));
	return (1);
}
